...
class Sphinx:
    ...
    def update_riddle(self, riddle: Riddle) -> str:
        """Updates the riddle.
            ...
            Args:
                riddle (Riddle): Riddle to update

            Returns:
                str: Information that riddle updated.
        """
        self._riddle = riddle
    ...
    def pose_riddle(self, include_hint: bool = False) -> tuple[str, str | None]:
        """
        Gives hint to the riddle.

            Args:
                include_hint (bool): Includes a hint. Defaults to False.
